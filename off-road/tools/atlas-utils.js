...
/**
 * Generate a Phaser 3 atlas JSON (hash-based) from frame definitions.
 * @param {string} imageFilename - The image file name (e.g. "vehicle_0.png")
 * @param {Array<{name:string, x:number, y:number, w:number, h:number}>} frames
 * @returns {object} Atlas JSON object
 */
...
/**
 * Save a canvas as PNG and its atlas JSON to the assets directory.
 * @param {Canvas} canvas
 * @param {string} subdir - e.g. "vehicles"
 * @param {string} baseName - e.g. "vehicle_0"
 * @param {Array} frames
 */
...
/**
 * Save a canvas as a standalone PNG (no atlas JSON).
 */
