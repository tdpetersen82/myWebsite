...
(function () {
  ...
  // ── Game catalog ───────────────────────────────────────────────────────
  // Single source of truth lives in games-catalog.js (loaded before this).
  const GAMES = window.LG_GAMES;
  ...
  const THUMBS = new Map([
    // Screenshots
    ['2048', 'webp'], ['asteroids', 'svg'], ['backgammon', 'webp'],
    ['blackjack', 'svg'], ['block-puzzle', 'svg'], ['breakout', 'svg'],
    ['checkers', 'webp'], ['chess', 'webp'], ['chinese-checkers', 'webp'],
    ['connect-4', 'webp'], ['connect-dots', 'webp'], ['craps', 'svg'],
    ['crazy-eights', 'svg'], ['defender', 'svg'], ['euchre', 'webp'],
    ['freecell', 'webp'], ['frogger', 'webp'], ['go-fish', 'svg'],
    ['hearts', 'svg'], ['lunar-lander', 'svg'], ['mahjong', 'webp'],
    ['mancala', 'webp'], ['memory-match', 'webp'], ['minesweeper', 'webp'],
    ['othello', 'webp'], ['pong', 'svg'], ['roulette', 'svg'],
    ['simon', 'svg'], ['slot-machine', 'webp'], ['snake', 'webp'],
    ['solar-system', 'svg'], ['solitaire', 'svg'], ['space-invaders', 'svg'],
    ['spacex-lander', 'svg'], ['spades', 'svg'], ['spider-solitaire', 'webp'],
    ['sudoku', 'webp'], ['texas-holdem', 'svg'], ['three-card-poker', 'svg'],
  ...
  const GAME_ART = new Map([
    ...
    ['crash', 'crash-casino-20260917.png'],
  ]);
  ...
  const GLYPH_PATHS = {
    ...
    // Euchre — the two bowers, one card behind the other.
    euchre: '<rect x="10" y="14" width="26" height="37" rx="3.5" fill="C" opacity="0.45" transform="rotate(-9 23 32)"/><rect x="27" y="12" width="27" height="38" rx="3.5" fill="C" transform="rotate(8 40 31)"/><path d="M44 22v13.5a4.2 4.2 0 0 1-8.4 0" fill="none" stroke="#fff" stroke-width="3.2" stroke-linecap="round"/>',
    ...
    'crossword-maker': '<rect x="24" y="8" width="16" height="16" rx="3" fill="C" opacity="0.55"/><rect x="8" y="24" width="16" height="16" rx="3" fill="C" opacity="0.55"/><rect x="24" y="24" width="16" height="16" rx="3" fill="C"/><rect x="40" y="24" width="16" height="16" rx="3" fill="C" opacity="0.55"/><rect x="24" y="40" width="16" height="16" rx="3" fill="C" opacity="0.55"/>',
    ...
    'hook-and-ladder': '<rect x="6" y="26" width="34" height="14" rx="3" fill="C"/><rect x="41" y="23" width="16" height="17" rx="3" fill="C"/><rect x="10" y="30" width="26" height="2" fill="#fff"/><rect x="10" y="35" width="26" height="2" fill="#fff"/><circle cx="14" cy="42" r="3.5" fill="#222"/><circle cx="32" cy="42" r="3.5" fill="#222"/><circle cx="50" cy="42" r="3.5" fill="#222"/>',
    ...
    'crash': '<path d="M10 52 C 24 50, 38 42, 50 18" fill="none" stroke="C" stroke-width="4" stroke-linecap="round"/><path d="M10 52 C 24 50, 38 42, 50 18 L 50 52 Z" fill="C" opacity="0.18"/><circle cx="50" cy="18" r="4.5" fill="C"/><path d="M10 12 V 52 H 54" fill="none" stroke="C" stroke-width="2" opacity="0.45"/>',
