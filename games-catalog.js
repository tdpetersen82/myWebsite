...
(function () {
  ...
  window.LG_GAMES = [
    ...
    { id: 'word-search',       name: 'Word Search',       cat: 'puzzle',  desc: 'Find hidden words — or make your own puzzle.', color: '#C96F2A', isNew: true },
    { id: 'crossword-maker',   name: 'Crossword Maker',   cat: 'puzzle',  desc: 'Your words, your clues — a printable crossword.', color: '#3D5A80', isNew: true },
