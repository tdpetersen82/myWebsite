...
(function () {
    ...
    var I = {
        ...
        solitaire: '<svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="6" width="10" height="18" rx="2" fill="#5DC4D9" transform="rotate(-12 7 15)" opacity="0.85"/><rect x="11" y="6" width="10" height="18" rx="2" fill="#fff" stroke="#5DC4D9" stroke-width="1.2"/><text x="13" y="14" font-size="6" font-weight="bold" fill="#5DC4D9">K</text><text x="14" y="22" font-size="6" fill="#5DC4D9">♠</text><rect x="20" y="6" width="10" height="18" rx="2" fill="#5DC4D9" transform="rotate(12 25 15)" opacity="0.85"/></svg>',
    ...
    const GAME_CATALOG = [
        ...
        },
        {
            ...
            games: [
                ...
                { name: 'Solitaire', icon: I.solitaire, url: 'solitaire/' },
        ...
        },
        {
            ...
            games: [
                ...
                { name: '3D Labyrinth (Three.js)', icon: I.labyrinth3js, url: 'labyrinth-threejs/' },
                { name: '3D Labyrinth (Babylon.js)', icon: I.labyrinthbjs, url: 'labyrinth-babylonjs/' },
                { name: 'Horse Feeding', icon: I.horsefeeding, url: 'horse-feeding/' },
            ]
        },
    ];
